...
include::../part-7-gui.adoc[tag=type_messages]
...
include::../part-8-items.adoc[tag=use_item_fn]
...
include::../part-9-spells.adoc[tag=target_tile_accept_in_fov,indent=4]
include::../part-9-spells.adoc[tag=target_tile_handle_cancel,indent=4]
    }
}
...
include::../part-9-spells.adoc[tag=cast_confuse_fn]
...
include::../part-8-items.adoc[tag=place_healing_potion,indent=12]
        }
    }
}
...
include::../part-9-spells.adoc[tag=render_all_header]
...
include::../part-7-gui.adoc[tag=message]
...
include::../part-8-items.adoc[tag=handle_keys_header]
...
include::../part-7-gui.adoc[tag=movement_keys,indent=8]
...
include::../part-9-spells.adoc[tag=tcod_struct]

fn main() {
include::../part-9-spells.adoc[tag=init,indent=4]

include::../part-1-graphics.adoc[tag=set_fps,indent=4]

include::../part-9-spells.adoc[tag=create_tcod_struct,indent=4]
...
include::../part-5-combat.adoc[tag=call_make_map,indent=4]

include::../part-9-spells.adoc[tag=create_fov_map,indent=4]

include::../part-8-items.adoc[tag=create_empty_inventory,indent=4]

include::../part-7-gui.adoc[tag=create_message_list,indent=4]
...
include::../part-7-gui.adoc[tag=initialise_key,indent=4]

include::../part-9-spells.adoc[tag=game_loop_while_header,indent=4]
include::../part-9-spells.adoc[tag=clear_offscreen_console,indent=8]

include::../part-9-spells.adoc[tag=check_for_event,indent=8]

include::../part-5-combat.adoc[tag=check_fov_recompute,indent=8]
include::../part-9-spells.adoc[tag=call_render_all,indent=8]

include::../part-9-spells.adoc[tag=root_flush,indent=8]

include::../part-7-gui.adoc[tag=previous_player_position,indent=8]
include::../part-9-spells.adoc[tag=call_handle_keys,indent=8]
include::../part-7-gui.adoc[tag=handle_player_action,indent=8]

include::../part-9-spells.adoc[tag=monsters_take_turn,indent=8]
    }
}
++++
