...
include::../part-7-gui.adoc[tag=render_all_header]
...
include::../part-7-gui.adoc[tag=panel_console,indent=4]
...
include::../part-7-gui.adoc[tag=initialise_mouse_and_key,indent=4]
