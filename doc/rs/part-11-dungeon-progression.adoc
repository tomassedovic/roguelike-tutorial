...
include::../part-11-dungeon-progression.adoc[tag=generate_monster_cb,indent=12]
...
include::../part-11-dungeon-progression.adoc[tag=place_healing_potion,indent=12]
...
include::../part-11-dungeon-progression.adoc[tag=next_level_fn]
...
include::../part-11-dungeon-progression.adoc[tag=player_fighter_cb,indent=4]

include::../part-5-combat.adoc[tag=create_objects_list,indent=4]

include::../part-11-dungeon-progression.adoc[tag=game_init,indent=4]
