...
include::../part-6-going-berserk.adoc[tag=fighter_struct]

include::../part-6-going-berserk.adoc[tag=ai_struct]

include::../part-6-going-berserk.adoc[tag=ai_take_turn]
...
include::../part-6-going-berserk.adoc[tag=generate_monster,indent=12]
...
include::../part-5-combat.adoc[tag=player_move_or_attack]
...
include::../part-6-going-berserk.adoc[tag=player_fighter,indent=4]

include::../part-5-combat.adoc[tag=create_objects_list,indent=4]

include::../part-5-combat.adoc[tag=call_make_map,indent=4]

include::../part-4-fov-exploration.adoc[tag=game_init,indent=4]
