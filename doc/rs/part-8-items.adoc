...
include::../part-7-gui.adoc[tag=ai_take_turn_header]
include::../part-6-going-berserk.adoc[tag=ai_take_turn_monster_move,indent=4]
include::../part-7-gui.adoc[tag=ai_take_turn_monster_attack,indent=12]
        }
    }
}

include::../part-8-items.adoc[tag=enum_item]
