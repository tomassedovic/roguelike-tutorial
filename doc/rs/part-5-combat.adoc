...
include::../part-5-combat.adoc[tag=object_struct]

include::../part-2-object-map.adoc[tag=object_impl_header]
include::../part-5-combat.adoc[tag=object_new,indent=4]
...
include::../part-5-combat.adoc[tag=generate_monster,indent=12]
...
include::../part-5-combat.adoc[tag=monsters_take_turn,indent=8]
    }
}
++++
