...
And finally, we need to update the item chances for this new
...
As you can see, we've the weighted chances really don't have to be
percentages. By setting the sword's value to `1000`, it's much more
likely to appear as any other item so we can find it early in the game
and test it!
