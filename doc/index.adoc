...
A port of the http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_python%2Blibtcod[Complete Roguelike Tutorial, using python+libtcod].
