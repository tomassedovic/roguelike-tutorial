...
[source,rust]
----
include::part-1-graphics.adoc[tag=init]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=set_fps]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=initial_game_loop]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=centre_player_position]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=handle_keys_full]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=match_key_full]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=match_special_keys]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=use_input_key]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=handle_exit_keys]
----
...
[source,rust]
----
include::part-1-graphics.adoc[tag=player_at_position]
----
