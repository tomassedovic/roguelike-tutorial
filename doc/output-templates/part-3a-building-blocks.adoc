...
++++
include::../part-1-graphics.adoc[tag=extern_tcod]

include::../part-3-dungeon.adoc[tag=use_cmp]

include::../part-2-object-map.adoc[tag=use_colors]
include::../part-1-graphics.adoc[tag=use_console]
...
include::../part-2-object-map.adoc[tag=make_map,indent=4]
