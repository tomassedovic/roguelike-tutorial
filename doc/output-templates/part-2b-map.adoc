...
include::../part-2-object-map.adoc[tag=make_map_header]

include::../part-2-object-map.adoc[tag=make_map_pillars,indent=4]

include::../part-2-object-map.adoc[tag=make_map_footer]
...
include::../part-2-object-map.adoc[tag=place_player,indent=4]
