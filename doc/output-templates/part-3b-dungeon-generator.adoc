...
++++
include::../part-3-dungeon.adoc[tag=extern_rand]
...
include::../part-3-dungeon.adoc[tag=make_map_init_starting_position,indent=4]
...
include::../part-3-dungeon.adoc[tag=make_map_with_starting_pos_footer]
}
...
include::../part-3-dungeon.adoc[tag=make_map,indent=4]
